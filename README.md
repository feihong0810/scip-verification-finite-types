...
|---:|---|---|---|---:|---|
| 1 | `{+++}` | `{+++}` | `case1.zpl` | `0.502002046236549` | optimal, gap 0.00% |
| 2 | `{+-+}` | `{+-+, +++}` | `case2.zpl` | `0.502002056992535` | optimal, gap 0.00% |
| 3 | `{-++}` | `{-++, +++}` | `case3.zpl` | `0.502002056466649` | optimal, gap 0.00% |
| 4 | `{++-, +-+}` | `{++-, +-+, +++}` | `case4.zpl` | `0.501006312450977` | optimal, gap 0.00% |
| 5 | `{+-+, -++}` | `{+-+, -++, +++}` | `case5.zpl` | `0.502005710088814` | optimal, gap 0.00% |
| 6 | `{+--}` | `{+--,<br>++-, +-+, +++}` | `case6.zpl` | `0.501005766533142` | optimal, gap 0.00% |
| 7 | `{++-, +-+, -++}` | `{++-, +-+,<br>-++, +++}` | `case7.zpl` | `0.556740687296275` | optimal, gap 0.00% |
| 8 | `{--+}` | `{--+, +-+,<br>-++, +++}` | `case8.zpl` | `0.502002052052246` | optimal, gap 0.00% |
| 9 | `{+--, -++}` | `{+--, ++-,<br>+-+, -++, +++}` | `case9.zpl` | `0.556445678716864` | optimal, gap 0.00% |
| 10 | `{++-, --+}` | `{++-, --+,<br>+-+, -++, +++}` | `case10.zpl` | `0.556740694697136` | optimal, gap 0.00% |
| 11 | `{+--, --+}` | `{+--, ++-, +-+,<br>--+, -++, +++}` | `case11.zpl` | `0.556447001450489` | optimal, gap 0.00% |
| 12 | `{-+-, --+}` | `{-+-, --+, ++-,<br>+-+, -++, +++}` | `case12.zpl` | `0.556741625284081` | optimal, gap 0.00% |
