...
| 6 | `{+--}` | `{+--, ++-, +-+, +++}` | `case6.zpl` | 0.5010 | optimal, gap 0.00% |
| 7 | `{++-, +-+, -++}` | `{++-, +-+, -++, +++}`  | `case7.zpl` | 0.5567 | optimal, gap 0.00% |
| 8 | `{--+}` | `{--+, +-+, -++, +++}`  | `case8.zpl` | 0.5020 | optimal, gap 0.00% |
| 9 | `{+--, -++}` | `{+--, ++-, +-+, -++, +++}` | `case9.zpl` | 0.5564 | optimal, gap 0.00% |
| 10 | `{++-, --+}` | `{++-, +-+, -++, --+, +++}` | `case10.zpl` | 0.5567 | optimal, gap 0.00% |
| 11 | `{+--, --+}` | `{+--, ++-, +-+, -++, --+, +++}` | `case11.zpl` | 0.5564 | optimal, gap 0.00% |
| 12 | `{-+-, --+}` | `{-+-, --+, ++-, +-+, -++, +++}` | `case12.zpl` | 0.5567 | optimal, gap 0.00% |
