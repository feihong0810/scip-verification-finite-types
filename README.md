...
|---:|---|---|---|---:|---|
| 1 | `{+++}` | `{+++}` | `case1.zpl` | `0.501001043535576` | optimal, gap 0.00% |
| 2 | `{+-+}` | `{+-+, +++}` | `case2.zpl` | `0.501001055960925` | optimal, gap 0.00% |
| 3 | `{-++}` | `{-++, +++}` | `case3.zpl` | `0.501001055868932` | optimal, gap 0.00% |
| 4 | `{++-, +-+}` | `{++-, +-+, +++}` | `case4.zpl` | `0.501003937891863` | optimal, gap 0.00% |
| 5 | `{+-+, -++}` | `{+-+, -++, +++}` | `case5.zpl` | `0.501004922702268` | optimal, gap 0.00% |
| 6 | `{+--}` | `{+--,<br>++-, +-+, +++}` | `case6.zpl` | `0.501003983667148` | optimal, gap 0.00% |
| 7 | `{++-, +-+, -++}` | `{++-, +-+,<br>-++, +++}` | `case7.zpl` | `0.55614918893721` | optimal, gap 0.00% |
| 8 | `{--+}` | `{--+, +-+,<br>-++, +++}` | `case8.zpl` | `0.501001051011187` | optimal, gap 0.00% |
| 9 | `{+--, -++}` | `{+--, ++-,<br>+-+, -++, +++}` | `case9.zpl` | `0.556149097085278` | optimal, gap 0.00% |
| 10 | `{++-, --+}` | `{++-, --+,<br>+-+, -++, +++}` | `case10.zpl` | `0.556148598387304` | optimal, gap 0.00% |
| 11 | `{+--, --+}` | `{+--, ++-, +-+,<br>--+, -++, +++}` | `case11.zpl` | `0.556149505011599` | optimal, gap 0.00% |
| 12 | `{-+-, --+}` | `{-+-, --+, ++-,<br>+-+, -++, +++}` | `case12.zpl` | `0.556150335787898` | optimal, gap 0.00% |
